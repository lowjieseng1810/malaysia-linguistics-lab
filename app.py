...
COURSE_DATA = {'iban': {1: {'steps': [{'type': 'scene',
                        ...
                        {'type': 'discover',
                         ...
                         'hint': 'Focus on the arrival moment: this line greets someone who has just come, not a name question or a how-are-you check.',
                        ...
                        {'type': 'discover',
                         ...
                         'hint': 'After a welcome, speakers often check on the other person — this is about wellbeing, not asking for a name or saying goodbye.',
                        ...
                        {'type': 'respond',
                         ...
                         'hint': 'They asked how you are — pick the short status reply, not a welcome or a name introduction.',
                        ...
                        {'type': 'discover',
                         ...
                         'hint': 'Names usually come after greetings: this ask is for identity, not direction or how someone feels.',
                        ...
                        {'type': 'respond',
                         ...
                         'hint': 'They asked for your name — start with the self-introduction pattern, not a welcome or a ‘fine’ reply.',
          ...
          2: {'steps': [{'type': 'vocabulary',
                        ...
                        {'type': 'quiz',
                         ...
                         'correctIndex': 2,
                         'hint': '“Kaban” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                        ...
                        {'type': 'quiz',
                         ...
                         'correctIndex': 1,
                         'hint': 'Pick the vocabulary item taught for “Eat” — nearby family/companion words are the usual traps.',
                        ...
                        {'type': 'quiz',
                         ...
                         'correctIndex': 1,
                         'hint': '“Apai” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                        ...
                        {'type': 'quiz',
                         ...
                         'correctIndex': 0,
                         'hint': 'Pick the vocabulary item taught for “Mother” — nearby family/companion words are the usual traps.',
          ...
          3: {'steps': [{'type': 'vocabulary',
                        ...
                        {'type': 'quiz',
                         ...
                         'options': ['Kini ke nuan?',
                                     ...
                                     'Aku enggau ...'],
                         'correctIndex': 2,
                         'hint': 'The target pattern opens with “Sapa…” — use that stem to separate it from the other question words.',
                        ...
                        {'type': 'quiz',
                         ...
                         'options': ['Where are you going?',
                                     ...
                                     'Where are you from?'],
                         'correctIndex': 1,
                         'hint': 'Read “Anang guai” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                        ...
                        {'type': 'quiz',
                         ...
                         'options': ['Aku enggau ...',
                                     ...
                                     'Sapa enggau nuan?'],
                         'correctIndex': 2,
                         'hint': 'Scan the options for the form that starts with “Kini” and matches this level’s gloss — not a similar-looking neighbour.',
                        ...
                        {'type': 'quiz',
                         ...
                         'options': ['Anang guai',
                                     ...
                                     'Ari ni penatai nuan?'],
                         'correctIndex': 1,
                         'hint': 'Among the choices, the form for “I am with ...” opens with “A…” — match the lesson gloss, not a look-alike.',
                        ...
                        {'type': 'quiz',
                         ...
                         'options': ['Where are you from?',
                                     ...
                                     'Wait a second'],
                         'correctIndex': 0,
                         'hint': 'Origin questions ask where someone comes from — '
                                 'not where they are going next.',
 ...
 'kadazan-dusun': {1: {'steps': [{'type': 'vocabulary',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': '“Kopivosian” is the greeting you open with — not thank-you and not a yes/no answer.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 2,
                                  'hint': 'Thank-you is its own formula in this lesson — do not pick the greeting or a yes/no particle.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'options': ['Greetings / hello', 'Thank you', 'Yes', 'No / not'],
                                  'correctIndex': 2,
                                  'hint': '“Oho” is a short yes/no-type reply from this level — not a greeting and not a thank-you.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': 'Look for the short negative particle taught here — it is not the greeting, not thank-you, and not the yes-form.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'options': ['What is your name?',
                                              ...
                                              'Yes'],
                                  'correctIndex': 0,
                                  'hint': '“Isai ngaran nu?” asks for or gives a personal name — not a greeting or a simple yes/no.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 2,
                                  'hint': 'Self-introduction starts with the ‘my name…’ pattern — not a greeting and not a yes/no reply.',
                   ...
                   2: {'steps': [{'type': 'vocabulary',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': '“tama” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'options': ['father', 'mother', 'child', 'sibling / relative'],
                                  'correctIndex': 2,
                                  'hint': '“tanak” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': 'Pick the vocabulary item taught for “sibling / relative” — nearby family/companion words are the usual traps.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': '“tulun” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 2,
                                  'hint': 'Pick the vocabulary item taught for “dog” — nearby family/companion words are the usual traps.',
                   ...
                   3: {'steps': [{'type': 'vocabulary',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': 'Read “Nunu?” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 2,
                                  'hint': 'Choose the form that was paired with “Who?” in this level’s vocabulary — not a related but different speech act.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'options': ['What?', 'Who?', 'Where?', 'Yes, thank you.'],
                                  'correctIndex': 2,
                                  'hint': 'Read “Hinonggo?” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 0,
                                  'hint': '“Au, kotohuadan.” is the gratitude line from this lesson — not the hello/greeting and not a yes/no particle.',
                                 ...
                                 {'type': 'quiz',
                                  ...
                                  'correctIndex': 2,
                                  'hint': 'Choose the open-meeting greeting from this level — not thank-you and not yes/no.',
                                  'correctFeedback': 'Correct. "Kopivosian." means "Greetings.".',
                                  'wrongFeedback': 'Not quite. The correct answer is '
                                                   '"Kopivosian.".'}]}},
 'bidayuh': {1: {'steps': [{'type': 'vocabulary',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': '“Siroi” is the greeting you open with — not thank-you and not a yes/no answer.',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 2,
                            'hint': 'Look for the short affirmative reply — not the greeting and not the negative particle.',
                           ...
                           {'type': 'quiz',
                            ...
                            'options': ['Hello / greeting', 'Yes', 'No', 'Thank you'],
                            'correctIndex': 2,
                            'hint': '“Indo” is a short yes/no-type reply from this level — not a greeting and not a thank-you.',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': '“Sima ngaran mu?” asks for or gives a personal name — not a greeting or a simple yes/no.',
             ...
             2: {'steps': [{'type': 'vocabulary',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': '“sama” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                           ...
                           {'type': 'quiz',
                            ...
                            'options': ['father', 'mother', 'child', 'relative / sibling'],
                            'correctIndex': 2,
                            'hint': '“anak” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': 'Pick the vocabulary item taught for “relative / sibling” — nearby family/companion words are the usual traps.',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': '“dayung” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 2,
                            'hint': 'Pick the vocabulary item taught for “friend” — nearby family/companion words are the usual traps.',
             ...
             3: {'steps': [{'type': 'vocabulary',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': 'Read “Onu?” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                           ...
                           {'type': 'quiz',
                            ...
                            'options': ['What?', 'Who?', 'Where?', 'Yes.'],
                            'correctIndex': 2,
                            'hint': 'Read “Dinu?” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                           ...
                           {'type': 'quiz',
                            ...
                            'correctIndex': 0,
                            'hint': 'Recall what “Indo.” was taught as in this level, then eliminate options that belong to a different speech act (greeting vs thanks vs yes/no vs name).',
                            'correctFeedback': 'Correct. "Indo." means "No.".',
                            'wrongFeedback': 'Not quite. "Indo." means "No.".'},
                           {'type': 'quiz',
                            'question': 'Which expression means "Thank you."?',
 ...
 'mah-meri': {1: {'steps': [{'type': 'vocabulary',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 0,
                             'hint': '“Selamat” is the greeting you open with — not thank-you and not a yes/no answer.',
                            ...
                            {'type': 'quiz',
                             ...
                             'options': ['Greeting / well-being', 'Thank you', 'Yes', 'No / not'],
                             'correctIndex': 2,
                             'hint': '“Ya” is a short yes/no-type reply from this level — not a greeting and not a thank-you.',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 0,
                             'hint': '“Nama?” asks for or gives a personal name — not a greeting or a simple yes/no.',
              ...
              2: {'steps': [{'type': 'vocabulary',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 0,
                             'hint': '“orang” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 2,
                             'hint': 'Pick the vocabulary item taught for “child” — nearby family/companion words are the usual traps.',
                             'correctFeedback': 'Correct. "anak" means "child".',
                            ...
                            {'type': 'quiz',
                             ...
                             'options': ['person / people', 'child', 'mother', 'father'],
                             'correctIndex': 2,
                             'hint': '“ibu” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 0,
                             'hint': 'Pick the vocabulary item taught for “father” — nearby family/companion words are the usual traps.',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 0,
                             'hint': '“kawan” is a people/kinship (or companion) word from this level — match the exact family role or relation, not a nearby look-alike.',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 2,
                             'hint': 'Choose the form that was paired with “family” in this level’s vocabulary — not a related but different speech act.',
              ...
              3: {'steps': [{'type': 'vocabulary',
                            ...
                            {'type': 'quiz',
                             ...
                             'options': ['What?', 'Who?', 'Where?', 'Yes, thank you.'],
                             'correctIndex': 0,
                             'hint': 'Read “Apa?” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                            ...
                            {'type': 'quiz',
                             ...
                             'options': ['What?', 'Who?', 'Where?', 'Yes, thank you.'],
                             'correctIndex': 2,
                             'hint': 'Read “Di mana?” as a question or request word: decide whether it asks who/what/where or tells someone to wait — then pick that meaning.',
                            ...
                            {'type': 'quiz',
                             ...
                             'options': ['No, thank you.', 'What?', 'Who?', 'Where?'],
                             'correctIndex': 0,
                             'hint': '“Tak, terima kasih.” is the gratitude line from this lesson — not the hello/greeting and not a yes/no particle.',
                            ...
                            {'type': 'quiz',
                             ...
                             'correctIndex': 2,
                             'hint': 'Among the choices, the form for “Welcome.” opens with “S…” — match the lesson gloss, not a look-alike.',
